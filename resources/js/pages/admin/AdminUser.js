              ...
              <div className="row">
                ...
                <div className="col-sm-4">
                  <div className="form-group">
                    ...
                    <input className="form-control" id="password" type="password" name="password" placeholder="Enter password" maxLength="100"
                ...
                <div className="col-sm-4">
                  <div className="form-group">
                    ...
                    <select className="form-control col-sm-3" id="role" name="role_id" onChange={handleChange} value={userInputs.role_id}>
                      {
                        lsRoles.length > 0 &&
                        lsRoles.map((role, i) =>
