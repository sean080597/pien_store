                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm-6 mb-sm-40">
                            <img src={process.env.PUBLIC_URL + CommonConstants.PRODUCTS_DIR + "/" + (productInfo.image ? productInfo.image.url : CommonConstants.PRODUCT_DEFAULT_IMAGE)} alt={productInfo.name} />
                        </div>
