                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-sm-5 col-sm-offset-1">
                                    <LazyLoadingImage src="https://images.ctfassets.net/00i767ygo3tc/2uG03zy1JOqRA1Avv0m2RF/322c69b49fa975772b98b77679cebfd8/instagram-story-highlight-cover.jpg" alt="story image"/>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-md-4 col-sm-6 col-xs-12" key={index}>
                                    <Link className="content-box" to={{ pathname: '/shop', state: { cate_id: cate.id } }}>
                                        <div className="content-box-image">
                                            <LazyLoadingImage src={CommonService.generateImageSrc(true, 'categories', cate)} alt={cate.name} />
                                        </div>
